                    ...
                    <div className="connect_tab">
                        <div className={classes.root}>
                                ...
                                <div className="voluntryInnerTabs">
                                            ...
                                            <div className="incentiveSbmt"><Button size="medium" className={classes.button}> <span className="font-size22 mr-12">+</span> PROVIDER TYPE </Button></div>                                        
                                            ...
                                            <Grid container direction="row" alignItems="top" spacing={0}>
                                                <Grid key={3} item xs={12} sm={12} lg={3}>
                                                  ...
                                                  <div className="admin_list">
                                                    <span>
                                                         <DeleteForeverIcon />
                                                         <img className="mt5" src="../../assets/images/icons/edit_GREEN.png" alt="" title="" width="20" />
                                                    </span>
                                                    <span>
                                                       55+ Community
                                                       <ul>
                                                          ...
                                                          <li>Estate planning</li>
                                                          <li>Estate planning</li>
                                                          <li><a href="#" className="blue-txt">ADD SPECIALITY</a></li>
                                                       </ul>
                                                    </span>
                                                  </div>
                                                  <div className="admin_list">
