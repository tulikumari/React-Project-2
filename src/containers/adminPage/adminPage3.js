                                                    ...
                                                    <Table>
                                                        <Thead>
                                                            <Tr>
                                                                ...
                                                                <Th className="text-center">ALERT USERS:</Th>
                                                                <Th className="text-center">PUBLISH:</Th>
                                                                <Th className="text-center">ARCHIVE IN: </Th>
                                                            ...
                                                            <Tr>
                                                                <Td className="text-center">
                                                                    <TextField
                                                                        ...
                                                                        label=""
                                                                        type="text"
                                                                        value="Alzheimer Cure on the Horizon"
                                                                        className="search_textbox"
                                                                    />
                                                                </Td>
                                                                <Td className="text-center">
                                                                ...
                                                                <Td className="text-center whiteBtn"><Button size="medium" color="secondary" className={classes.button}> YES </Button></Td>
                                                                <Td className="text-center">25 Days</Td>
