                                ...
                                <div className="voluntryInnerTabs">
                                            ...
                                            <Grid container direction="row" alignItems="top" spacing={0}>
                                                <Grid key={3} item xs={12} sm={12} lg={3}>
                                                  <div className="incentiveSbmt"><Button size="medium" className={classes.button}> <span className="font-size22 mr-12">+</span> ADD RATE </Button></div>                                        
                                                ...
                                                <Grid key={3} item xs={12} sm={12} lg={3}>
                                                  <div className="incentiveSbmt"><Button size="medium" className={classes.button}> <span className="font-size22 mr-12">+</span> ADD PAYMENT TYPE </Button></div>                                        
                                                  <div className="admin_list">
                                                    <span>
                                                         <DeleteForeverIcon />
                                                         <img className="mt5" src="../../assets/images/icons/edit_yellow.png" alt="" title="" width="20" />
